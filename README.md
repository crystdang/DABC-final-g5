...
An initial ERD was sketched out showing the 5 tables described above. However, as the project progressed, it was decided that these tables were no longer needed and a simpler diagram was provided.
...
- An initial sketch of the dashboard is available to be viewed.
